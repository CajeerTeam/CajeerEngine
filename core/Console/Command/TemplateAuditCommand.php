...
#[AsCommand(name: 'template:audit', description: 'Проверить .cjr-шаблоны и sandbox-риск.')] 
final class TemplateAuditCommand extends BaseCommand
{
    ...
    {
        $checks = array_map(static fn ($check): array => $check->toArray(), (new TemplateSandboxAuditor($this->rootPath))->audit());
