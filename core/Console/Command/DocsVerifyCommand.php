...
#[AsCommand(name: 'docs:verify', description: 'Проверить обязательные документы проекта.')] 
final class DocsVerifyCommand extends BaseCommand
{
    ...
    {
        $checks = array_map(static fn ($check): array => $check->toArray(), (new DocsVerifier($this->rootPath))->verify());
