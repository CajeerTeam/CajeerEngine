...
#[AsCommand(name: 'stable:lock', description: 'Создать release lock для стабильного релиза.')]
final class StableLockCommand extends BaseCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $service->writeReleaseLock([]);
        ...
        if ((bool) $input->getOption('json')) {
            ...
            $output->writeln('Stable release lock: ' . ($ok ? 'OK' : 'FAILED'));
