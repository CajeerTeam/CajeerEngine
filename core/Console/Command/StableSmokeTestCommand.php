...
#[AsCommand(name: 'stable:smoke-test', description: 'Запустить production smoke-test стабильного релиза.')]
final class StableSmokeTestCommand extends BaseCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ((bool) $input->getOption('json')) {
            ...
            $output->writeln('Stable smoke-test: ' . ($ok ? 'OK' : 'FAILED'));
