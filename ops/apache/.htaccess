...
Проект использует нативную систему тем. Первая полноценная тема — `themes/cajeer-official`, адаптированная из шаблона сайта Cajeer. Публичные assets темы отдаются из `public/themes/cajeer-official/assets`, а приватные шаблоны остаются в `themes/cajeer-official/views`.

Подробности: `wiki/Theme-System.md`.
